import numpy as np
import torch
from e2efs_pytorch import default_models
from e2efs_pytorch import e2efs_layers
from e2efs_pytorch.e2efs_models import E2EFSModel
...
class E2EFSBase:
    ...
    def __build_mask__(self, input_shape):
        return getattr(e2efs_layers, self.mask_name)(input_shape=input_shape, n_features_to_select=self.n_features_to_select)
