...
import torchmetrics
from e2efs_pytorch.metrics import BalancedAccuracy
from e2efs_pytorch import networks
...
class DefaultClassifier(pl.LightningModule):
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.SGD(self.parameters(), lr=.01, weight_decay=self.regularization)
        return optimizer
